...
3. On the Deploy model gpt-35-turbo pop-up , enter the deployment name as **davinci003 (1)**,from Model Version drop-down select **0125(2)** and scale down the **Tokens per Minute Rate Limit (thousands) (3)** to **5k** then click on **Deploy (4)**.
