...
1. In the **Azure OpenAI Studio**, select **Deployments** under Management and click on **+ Deploy model** and select **Deploy base model**.
...
1. Now again Click on **+ Deploy model** and select **Deploy base model**.

   ![](Images/newdeployment01.png)
   
3. On the Deploy model pop-up, enter the deployment name as **davinci003 (1)**, from the drop-down select **gpt-35-turbo(2)** for Select a Model,from Model Version drop-down select **0125(3)** and scale down the **Tokens per Minute Rate Limit (thousands) (4)** to **5k** then click on **Create (5)**.
