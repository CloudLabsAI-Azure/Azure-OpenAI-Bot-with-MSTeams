...
In this exercise, you will be installing the required packages from Machine learning studio. You will also be deploying the Model in Open AI by running the python notebook from Machine learning studio
...
* In this exercise, you have installed the required packages from Machine learning studio and deployed the Model in Open AI by running the python notebook from Machine learning studio.
