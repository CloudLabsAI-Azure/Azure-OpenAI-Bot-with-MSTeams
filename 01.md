...
1. On the Deploy model pop-up, enter the deployment name as **ada002 (1),from the drop-down select **text-embedding-ada-002 (2)** for Select a Model, and scale down the **Tokens per Minute Rate Limit (thousands) (3)** to **5k** then click on **Create (4)**.

   ![](Images/update2.jpg)

1. Click on **+ Create new deployment**, On the Deploy model pop-up, enter the deployment name as **davinci003 (1)**, from the drop-down select **gpt-35-turbo-instruct (2)** for Select a Model,and scale down the **Tokens per Minute Rate Limit (thousands) (3)** to **5k** then click on **Create (4)**.

   ![](Images/EMPOWERING-KNOWLEDGE-lab1-2.png)
