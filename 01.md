...
In this task you will be running the requiremnts.txt file to install the required the packages in Machine learning workspace.
...
In this task, you will update the config file with the Keys and endpoints values of Azure Open AI
...
In this task you will review and run the python notebook to deploy the model in Azure Open AI
...
In this task you will be reviewing the deployed models from Azure Open AI
