...
5. On Microsoft Azure Machine Learning Studio Click on **Notebooks (1)** and click on **Open Terminal (2)** and run the below-mentioned commands
   ...
   ![](Images/piprequiremnt.png)
      ...
      > **Note** : Please ignore any warnings during the execution. The final output should indicate that the process has succeeded and the installation is complete.
...
6. Now you need to restart the compute instance after installing the required packages. Follow the below steps to restart the compute instance:
...
>**Note :** If you encounter issues, you can restart the kernel, clear all outputs, and try running all the cell again.
