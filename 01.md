...
1. Click on **+ Create new deployment**, On the Deploy model pop-up, enter the deployment name as **davinci003 (1)**, from the drop-down select **gpt-35-turbo(2)** for Select a Model,from Model Version drop-down select **0125(3)** and scale down the **Tokens per Minute Rate Limit (thousands) (4)** to **5k** then click on **Create (5)**.
