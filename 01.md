...
1. On the OpenAI **Overview (1)** page , click on **Go to Azure AI Foundry portal (2)** for navigating to Azure AI Foundry.

   ![](Images/n13.png)

1. In the **Azure AI Foundry**, select **Deployments** under Shared resources ,click on **+ Deploy model** and select **Deploy base model**.
