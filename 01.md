...
1. Now navigate back to the Azure portal, click on **Keys and Endpoints (1)**, select **Show Keys (2)**, and copy the values of **Key 1 (3)** and **Language APIs (4)** in a notepad. You will be using these values in the next steps.
