...
3. Run the below command to clone the repo.
    ...
    ```
    git clone -b guided-lab https://github.com/CloudLabsAI-Azure/BotBuilder-Samples
    ```

### Task 2: Deploy Azure App service using ARM template

1. Open your web browser and navigate to the Azure Portal. Sign in with your Azure account.
...
4. Navigate to **C:\LabFiles\BotBuilder-Samples\samples\csharp_dotnetcore\03.welcome-user\DeploymentTemplates\DeployUseExistResourceGroup\** select **template-BotApp-with-rg.json** and click on save.

5. Provide the details in the 
   App Service Name: botapplication-101151
   New App Service Plan Name: botapplicationplan-101151
   New App Service Plan Location: Same as resource group
   New App Service Plan Sku: {"name":"F1","tier":"Free","size":"F1","family":"F","capacity":1}
   App Type: Multitenant
   App Id: Application ID of App registration
   App Secret: Secret Key of App registration
...
4. On the Visual Studio Code pop click on **Yes**
