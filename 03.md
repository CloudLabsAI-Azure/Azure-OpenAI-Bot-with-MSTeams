...
1. Replace the values in the **.env** file then click on **esc** followed by **:wq**.
    ...
    ![](Images/wq.png)
      ...
      >**Note**: From **Environment Details** page, under **Service Principal Details** fetch and replace the values repectively 
      >
      >  - **MicrosoftAppId**: **Application Id**
      >  - **MicrosoftAppPassword**: **Secret Key**
      >  - **MicrosoftAppTenantId**: **Tenant Id (Directory id)** 
