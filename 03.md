...
1. Replace the values in the **.env** file then click on **esc** followed by **:wq**.
    ...
    ![](Images/wq.png)
      ...
      >**Note**: You can find the Values for **MicrosoftAppId** **MicrosoftAppPassword** and **MicrosoftAppTenantId** in **Environment Details** page under **Service Principal Details**.
