# Exercise 3: Deploying the chatbot on Azure Bot Service and Azure App Service and Setting up Email Automation Workflow on Azure Logic
...
In this exercise, you have deployed the chatbot on Azure Bot Service and Azure App Service, publish the chatbot on the Microsoft Teams channel using a manifest file and added knowledge base documents using Azure Logic Apps.
