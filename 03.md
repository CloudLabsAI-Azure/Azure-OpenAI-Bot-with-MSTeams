...
### Task 5 : Add more knowldge base documents using Azure Logic Apps. 
...
1. Now navigate back to teams bot to verify the latest document added into the bot.

1. Enter Restart the bot to have the changes reflect. 

   > **Note :** Wait for 2-3 minutes to get the bot get restarted.

1. Once the bot is restart, Send Hi to start the conversation and select qna to see the documentation. 
...
1. You can start checking for the queries.

    ![](Images/askquery.png)
    
The lab ends here. You have learned on how to work with Azure OpenAI and integrate with you knowldge base. 
