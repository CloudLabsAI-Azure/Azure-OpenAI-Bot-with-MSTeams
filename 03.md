...
1. Replace the values in the **.env** file then click on **esc** followed by **:wq**.
    ...
    ![](Images/wq.png)
      ...
      >**Note**: Replace the value of **API_BASE_URL** with **https://openaiwebapp<inject key="DeploymentID" enableCopy="false"/>.azurewebsites.net**

 
      >**Note**: Replace the value of  **MicrosoftAppId** with **Application Id**, **MicrosoftAppPassword** with **Secret Key** and **MicrosoftAppTenantId** with **Tenant Id (Directory id)** from **Environment Details** page under **Service Principal Details**.
