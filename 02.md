...
1. If the cell execution fails, you can alternatively you can navigate to the resource group, select the web app, go to the overview page, click on "Browse," and copy the link.
