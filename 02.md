...
1. From **Microsoft Azure Machine Learning Studio**, click on **Compute (1)** and select **VS Code (Desktop) (2)** next to **mlmodelcompute<inject key="DeploymentID" enableCopy="false"/>** Compute Instance.

    ![](Images/EX2-Task3-Step1.png)
